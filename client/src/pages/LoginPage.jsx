...
const LoginPage = () => {
  useEffect(() => {
    document.title = 'Login | Platinum Casino';
  }, []);
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-bg-card rounded-xl shadow-card overflow-hidden border border-border">
            ...
            <form onSubmit={handleSubmit} className="p-6 pt-2">
              ...
              <div className="mb-6">
                <div className="mb-2">
                  <label htmlFor="password" className="block text-text-secondary text-sm font-medium">Password</label>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-text-muted" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="mt-6 text-center text-text-secondary">
                <p className="text-sm">
                  Don't have an account? <Link to="/register" className="text-accent-gold hover:text-accent-gold-light font-medium transition-colors">Create Account</Link>
                </p>
              </div>
            </form>
          </div>
