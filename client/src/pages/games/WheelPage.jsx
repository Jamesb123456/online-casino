    ...
    <MainLayout>
      ...
      <div className="mt-12 bg-gray-800 rounded-lg p-6">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-300">
          <li><span className="text-amber-400 font-semibold">Choose Difficulty</span> - Select your preferred risk level</li>
          <li><span className="text-amber-400 font-semibold">Set Bet Amount</span> - Enter how much you want to wager</li>
          <li><span className="text-amber-400 font-semibold">Spin the Wheel</span> - Click to spin and see where it lands</li>
          <li><span className="text-amber-400 font-semibold">Collect Winnings</span> - Your winnings are calculated based on the multiplier</li>
        </ol>
